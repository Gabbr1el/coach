...
export interface MaterialSummary { readonly id: string; readonly name: string; readonly pageCount: number; readonly status: 'staged' | 'ready' | 'failed' | 'archived'; readonly relevance: number; readonly sourceUrl: string | null; readonly createdAt: number }
