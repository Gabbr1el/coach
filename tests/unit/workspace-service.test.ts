...
import { workspaceAnalysisSignature } from '../../src/application/workspaces/subject-normalizer'
...
describe('WorkspaceService', () => {
  const analyzed = (name: string, focus = name, context = '') => ({ analysisRevision: 10, analysisToken: `10.${workspaceAnalysisSignature(name, focus, context)}`, canonicalFocus: focus, canonicalContext: context })
