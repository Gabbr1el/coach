...
export function App() {
  ...
  if (selected) {
    ...
    const openNextStep = () => {
      if (!nextStep) return
      if (nextStep.route === 'studies') openStudies(nextStep.moduleId ?? undefined)
      else if (nextStep.route === 'exercises') openExercises(undefined, nextStep.topicId ?? undefined)
      else selectPage(nextStep.route)
    }
    return (
