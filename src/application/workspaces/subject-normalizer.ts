const SUBJECTS: Array<[RegExp, string]> = [[/\bjavafx\b/i, 'JavaFX'], [/\bpython\b/i, 'Python'], [/\bjavascript\b/i, 'JavaScript'], [/\btypescript\b/i, 'TypeScript'], [/\bjava\b/i, 'Java'], [/(?:\blinguagem\s+)?\bc(?![\p{L}\p{N}_])/iu, 'C'], [/redes? de computadores/i, 'Redes de Computadores']]
