...
const api: CoachDesktopApi = {
  ...
  provider: {
    ...
    listAvailableModels: (accountId) => ipcRenderer.invoke(PROVIDER_CHANNELS.listAvailableModels, accountId),
    refreshHealth: () => ipcRenderer.invoke(PROVIDER_CHANNELS.refreshHealth),
    ...
    beginGitHubCopilotOAuth: () => ipcRenderer.invoke(PROVIDER_CHANNELS.beginGitHubCopilotOAuth),
  ...
  planning: {
    ...
    getWeeklyPlan: (anchorDate) => ipcRenderer.invoke(PLANNING_CHANNELS.getWeeklyPlan, anchorDate ? { anchorDate } : {}),
