...
export class RoadmapService {
  ...
  async accept(workspaceId: string, roadmapId: string): Promise<Roadmap> { await this.requireWorkspace(workspaceId); const roadmap = this.repository.accept(workspaceId, roadmapId, this.now()); this.onRoadmapChanged?.(roadmap); return roadmap }
