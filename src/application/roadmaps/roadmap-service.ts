...
function schemaDescription(): string { return '{"title":string,"modules":[1..16 {"title":string,"objective":string,"estimatedMinutes":integer 10..2400,"topics":[1..12 non-empty strings],"outcomes":[1..8 strings],"practice":string,"completionCriteria":[1..6 strings],"sourceIds":[0..6 provided IDs]}]}' }
