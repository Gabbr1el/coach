...
export interface AcademicMutationResult { readonly changed: boolean; readonly summary: string; readonly workspaceIds: string[]; readonly needsRefinement: string | null }
