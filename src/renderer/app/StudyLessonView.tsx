...
const reasoningLabels = { coherent: 'Raciocínio coerente', partial: 'Raciocínio parcial', misconception: 'Concepção equivocada', insufficient: 'Justificativa insuficiente', off_topic: 'Justificativa fora do tema', reasoning_evaluation_pending: 'Avaliação do raciocínio pendente' } as const
