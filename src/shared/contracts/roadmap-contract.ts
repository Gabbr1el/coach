...
export const roadmapResourceSchema = z.object({ title: z.string().trim().min(1).max(160), url: z.url().max(1000), type: z.enum(['roadmap', 'documentation', 'course', 'article', 'video']) }).strict()
